...
function Interest() {
    ...
    <div id="#interests" className='flex-col w-5/6 mx-auto pb-10'>
        ...
        >
            ...
            <Underline />
            <br />
            <p className='text-lg mb-8'>These are some hobbies of mine that I've consistently enjoyed putting work into!</p>
            <br />
        </motion.div>
        

        <div className='flex flex-col xl:flex-row xl:justify-center gap-16 xl:gap-5 mt-36 mb-9'>
