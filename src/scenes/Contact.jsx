        ...
        <div id="#contact">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-10 sm:gap-20">
                ...
                >
                    ...
                    <br />
                    <i><p className="text-2xl font-montserrat">The ball is in your court!</p></i>
            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        className="px-3 py-2 mb-10 bg-stone-600 font-semibold text-stone-300 hover:bg-stone-300 hover:text-stone-600 rounded-md transition-all duration-0 min-w-28 whitespace-nowrap"
                        type="submit"
                    >
                        {buttonText}
                    </button>
